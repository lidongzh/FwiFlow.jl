...
class Upw_LapOp : public OpKernel {
 private:

 public:
  explicit Upw_LapOp(OpKernelConstruction* context) : OpKernel(context) {
...
REGISTER_KERNEL_BUILDER(Name("Upw_Lap").Device(DEVICE_CPU), Upw_LapOp);


REGISTER_OP("Upw_LapGrad")
...
class Upw_LapGradOp : public OpKernel {
 private:

 public:
  explicit Upw_LapGradOp(OpKernelConstruction* context) : OpKernel(context) {
...
REGISTER_KERNEL_BUILDER(Name("Upw_LapGrad").Device(DEVICE_CPU), Upw_LapGradOp);
