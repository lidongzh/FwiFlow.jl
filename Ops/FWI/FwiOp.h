...
cufd(double *res, double *grad_Cp, double *grad_Cs, double *grad_Den,
     ...
     const double *stf, int calc_id, int gpu_id, int group_size,
     const int *shot_ids, string para_fname);

void forward(double *res, const double *Cp, const double *Cs, const double *Den,
             double *stf, int gpu_id, int group_size, const int *shot_ids,
             string para_fname) {
...
void backward(double *grad_Cp, double *grad_Cs, double *grad_Den,
              ...
              const double *Den, double *stf, int gpu_id, int group_size,
              const int *shot_ids, string para_fname) {
